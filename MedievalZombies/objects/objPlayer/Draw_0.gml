...
var drawOffset = scrWave(-1, 1, 1, 0)*moveSpeed*0.1;
//right foot
...
draw_sprite_ext(footSprite, -1, drawX+lengthdir_x(footOffset, bodyDirection+90)+lengthdir_x(-drawOffset, bodyDirection), drawY+lengthdir_y(footOffset, bodyDirection+90)+lengthdir_y(-drawOffset, bodyDirection), 1, 1, bodyDirection, c_white, 1);
//left weapon
draw_sprite_ext(weaponSpriteLeft, -1, drawX+lengthdir_x(handOffset, bodyDirection+90)+lengthdir_x(drawOffset, bodyDirection), drawY+lengthdir_y(handOffset, bodyDirection+90)+lengthdir_y(drawOffset, bodyDirection), 1, 1, bodyDirection, c_white, 1);
//right weapon
draw_sprite_ext(weaponSpriteRight, -1, drawX+lengthdir_x(handOffset, bodyDirection-90)+lengthdir_x(-drawOffset, bodyDirection), drawY+lengthdir_y(handOffset, bodyDirection-90)+lengthdir_y(-drawOffset, bodyDirection), 1, 1, bodyDirection, c_white, 1);
