...
draw_text(phy_position_x, phy_position_y-20, string(poise) + "/" + string(maxPoise));
draw_text(phy_position_x, phy_position_y-35, string(hitpoints) + "/" + string(maxHitpoints));